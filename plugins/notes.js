...
Asena.addCommand({ pattern: 'notlar', fromMe: true, desc: Lang.NOTES_USAGE }, async (message, match) => {
...
Asena.addCommand({ pattern: 'notkaydet ?(.*)', fromMe: true, desc: Lang.SAVE_USAGE }, async (message, match) => {
...
Asena.addCommand({ pattern: 'notsil', fromMe: true, desc: Lang.DELETE_USAGE }, async (message, match) => {
