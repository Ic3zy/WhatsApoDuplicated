...
if (Config.WORKTYPE == 'private') {
    Asena.addCommand({ pattern: 'tarama ?(.*)', fromMe: true, desc: Lang.SCAN}, (async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'tarama ?(.*)', fromMe: false, desc: Lang.SCAN}, (async (message, match) => { 
